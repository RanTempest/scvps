...
echo -e "     \e[1;32m2)\e[0m Gunakan Domain Random Khusus (Digital Ocean) "
echo -e "   ------------------------------------"
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/RanTempest"},{"text":"Contack","url":"https://wa.me/6283141751466"}]]}'
...
wget raw.githubusercontent.com/RanTempest/scvps/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
