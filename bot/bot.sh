...
# //  telegram: https://t.me/rantempest
# //====================================================
# // font color configuration |TEMPEST  AUTOSCRIPT
...
rm -rf bot.zip
clear
wget wget https://raw.githubusercontent.com/RanTempest/scvps/main/limit/kyt.zip
unzip kyt.zip
